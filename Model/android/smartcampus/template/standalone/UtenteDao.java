...
public class UtenteDao extends AbstractDao<Utente, Void> {
    ...
    */
    public static class Properties {
        public final static Property Nome = new Property(0, String.class, "nome", false, "NOME");
        public final static Property Cognome = new Property(1, String.class, "cognome", false, "COGNOME");
        public final static Property Ruolo = new Property(2, String.class, "ruolo", false, "RUOLO");
        public final static Property Ambito = new Property(3, String.class, "ambito", false, "AMBITO");
        public final static Property Foto = new Property(4, byte[].class, "foto", false, "FOTO");
        public final static Property NumeroTelefonico = new Property(5, String.class, "numeroTelefonico", false, "NUMERO_TELEFONICO");
    };
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'UTENTE'";
        db.execSQL(sql);
    }
    ...
    public void readEntity(Cursor cursor, Utente entity, int offset) {
        ...
        entity.setCognome(cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1));
        entity.setRuolo(cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2));
        entity.setAmbito(cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3));
        entity.setFoto(cursor.isNull(offset + 4) ? null : cursor.getBlob(offset + 4));
        entity.setNumeroTelefonico(cursor.isNull(offset + 5) ? null : cursor.getString(offset + 5));
     }
