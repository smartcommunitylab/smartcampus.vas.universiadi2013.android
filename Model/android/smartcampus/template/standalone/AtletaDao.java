...
public class AtletaDao extends AbstractDao<Atleta, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Disciplina = new Property(4, String.class, "disciplina", false, "DISCIPLINA");
        public final static Property Foto = new Property(5, byte[].class, "foto", false, "FOTO");
    };
    ...
    protected void bindValues(SQLiteStatement stmt, Atleta entity) {
        ...
        String disciplina = entity.getDisciplina();
        if (disciplina != null) {
            stmt.bindString(5, disciplina);
        }
 
        byte[] foto = entity.getFoto();
        if (foto != null) {
            stmt.bindBlob(6, foto);
        }
    }
    ...
    public Atleta readEntity(Cursor cursor, int offset) {
        Atleta entity = new Atleta( //
            ...
            cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4), // disciplina
            cursor.isNull(offset + 5) ? null : cursor.getBlob(offset + 5) // foto
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Atleta entity, int offset) {
        ...
        entity.setDisciplina(cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4));
        entity.setFoto(cursor.isNull(offset + 5) ? null : cursor.getBlob(offset + 5));
     }
