...
public class PageInfoSport extends Fragment {
	...
	public PageInfoSport(ElementSport sport, int position)
	{
		mSport = sport;
		mPosition = position;
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		case 0: mContainerDesc.setVisibility(View.VISIBLE);
			...
			((FontTextView)mView.findViewById(R.id.text_descrizione)).setText(mSport.getmDescrizione());
			break;
...
private class ListSportArrayAdapter extends ArrayAdapter<ElementAtleta>
{
	private final Context context;
	private final ArrayList<ElementAtleta> values;

	public ListSportArrayAdapter(Context context, ArrayList<ElementAtleta> values) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		((FontTextView)rowView.findViewById(R.id.text_nome_cognome)).setText
			(values.get(position).getmCognomeAtleta()+" "+
					values.get(position).getmNomeAtleta());
		
		((FontTextView)rowView.findViewById(R.id.text_nazionalita)).setText
		(values.get(position).getmNazionalita());
